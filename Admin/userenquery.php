						...
						<div class="page-header float-right">
							<div class="page-title">
								<ol class="breadcrumb text-right">
									...
									<li class="active">User Enquery</li>
								</ol>
							</div>
						</div>
					</div>
...
<tr><td class="toptd">View User Enquery</td></tr>
...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<tr><td style=' padding:5px;'>$data[1]</td><td style=' padding:5px;'>$data[2]</td><td style=' padding:5px;'>$data[3]</td><td style=' padding:5px;'>$data[4]</td></tr>";
