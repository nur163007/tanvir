	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">
		 ...
		 <div class="col-md-4 about-grids">
             ...
             <div align="right"><a href="aboutus.php"><input type="button" class="more"value="Read More..." name="sbmt" /></a></div>
		 </div>
	 </div>
</div>
<!--/About-->
...
<?php 
$cn=makeconnection();
$sql="select * from package where Packtype = '1'";
...
?>
					<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="subcat.php?catid=<?php echo $data['Category']; ?>" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="Admin/packimages/<?php echo $data['Pic1']; ?>"  alt="" height="250px" width="300px"/></a>
                             </div>
					</div>
						<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="subcat.php?catid=<?php echo $data['Category']; ?>" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="Admin/packimages/<?php echo $data['Pic2']; ?>"  alt=""height="250px" width="300px"/></a>
                             </div>
					</div>
						<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="subcat.php?catid=<?php echo $data['Category']; ?>" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="Admin/packimages/<?php echo $data['Pic3']; ?>" alt=""height="250px" width="300px"/></a>
                             </div>
					</div>
<?php }?>
...
<?php 
$cn=makeconnection();
$sql="select * from package where Packtype = '2'";
$result=mysqli_query($cn,$sql);
while($data=mysqli_fetch_assoc($result)){
// {echo "<pre>";
// print_r($data);
...
?>
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="subcat.php?catid=<?php echo $data['Category']; ?>" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="Admin/packimages/<?php echo $data['Pic1']; ?>" height="250px" width="300px" alt=""/></a>
					...
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="subcat.php?catid=<?php echo $data['Category']; ?>" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="Admin/packimages/<?php echo $data['Pic2']; ?>" height="250px" width="300px" alt=""/></a>
					...
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="subcat.php?catid=<?php echo $data['Category']; ?>" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="Admin/packimages/<?php echo $data['Pic3']; ?>" height="250px" width="300px" alt=""/></a>
...
<?php 
$cn=makeconnection();
$sql="select * from package where Packtype = '3'";
$result=mysqli_query($cn,$sql);
while($data=mysqli_fetch_assoc($result)){
// {echo "<pre>";
// print_r($data);
...
<?php 
$cn=makeconnection();
$sql="select * from package where Packtype = '4'";
$result=mysqli_query($cn,$sql);
while($data=mysqli_fetch_assoc($result)){
// {echo "<pre>";
// print_r($data);
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 <img src="Admin/addverimages/<?php echo $data['Pic'];?>" width="300px" height="150px" >

					 <p><a href="<?php echo $data['Companyname'];?>"target="_blank">Go to visit the site</a></p>
				 </div>
				<?php if($n%4==3)
				{?>
            </div>
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">Tourism Management</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+880) 1685590095&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;01685590095</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">www.code-tanvir.org</a></h5>
...
?>
                      ...
                      <tr><td align="left"> <input type="text" class="text" placeholder="Name" name="t1" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Your Name';}" required pattern="[a-zA-z1 _]{1,50}" title"Please Enter Only Characters and numbers between 1 to 50 for Name"></td></tr>
                      <tr><td align="left"><input type="text" class="text" placeholder=" Contact No" name="t2" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Your Contact NO';}" required pattern="[0-9]{10,12}" title"Please Enter Only  numbers between 10 to 12 for Contact no"></td></tr>
					 <tr><td align="left"> <input type="text" class="text" placeholder="Email" name="t3" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Your mail';}" required></td></tr>
					 <tr><td><textarea onFocus="if(this.value == 'Message') this.value='';" name="t4" onBlur="if(this.value == '') this.value='Enter Message Here';" placeholder="Message"required/ ></textarea></td></tr>
...
<!-- 		<?php
// $s="select * from package where Packtype = 1";
// $result=mysqli_query($cn,$s);
...
// while($data=mysqli_fetch_array($result))
{
	?>
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="../packimages/<?php //echo $data['Pic1'];?>" class="img-responsive" alt=""/></a>
						     <?php }?> 