...
<tr><td class="middletext"><img src="Admin/packimages/<?php echo $data[6];?>" width="200px" height="200px"  /></td>

<td class="middletext" style="padding-left:15px"><img src="Admin/packimages/<?php echo $data[7];?>" width="200px" height="200px"  /></td>

<td class="middletext" style="padding-left:15px"><img src="Admin/packimages/<?php echo $data[8];?>" width="200px" height="200px"  /></td>
</tr>
...
<tr><td colspan="3"><p><?php echo $data[9];?></p></td></tr>
<tr><td align="left" colspan="3" height="50px"><a href="enquiry.php?pid=<?php echo $data[0];   ?>"><input type="button" value="Book Now" name="sbmt" /></a></td></tr>
</table>
</td>
</tr>
</table>
